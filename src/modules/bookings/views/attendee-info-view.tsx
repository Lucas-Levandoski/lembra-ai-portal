...
import { SuccessBookingCard, TimeDescription } from 'Bookings/components';
...
export function AttendeeInfoView({ userTag, agendaTag, date }: props) {
  const { 
    ...
    onSubmit, 
    onChangeProperty
  } = useOnAttendeeInfo(userTag, agendaTag, date);
                        ...
                        : (
                          <>
                            ...
                            <div className="border rounded-lg p-4 flex items-center gap-6">
                              ...
                              {
                                time && <TimeDescription startTime={time} endTime={sumMinutesToTime(time, agenda.timeFrame)} date={date} />
                              }
                            </div>
                          </>
                        )  
