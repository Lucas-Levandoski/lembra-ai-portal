...
const variants: { [key in Variant]: string } = {
  primary: 'bg-blue-700 text-white border-primary h-12 min-w-32',
  secondary: 'bg-slate-100 text-gray-900 border-primary h-12 min-w-32',
  danger: 'bg-red-500 text-white border-primary h-12 min-w-32',
  outlined: 'bg-white text-primary border-2 border-primary h-12 min-w-32',
