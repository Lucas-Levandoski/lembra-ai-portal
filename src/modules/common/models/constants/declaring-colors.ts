...
// this constant purpose is to have the color class declared inside the project for tailwind to pick it up
export const DeclaredColors = [
  ...
  'bg-fuchsia-500', 'bg-fuchsia-100', 'text-fuchsia-700', 'text-fuchsia-700',
  'bg-violet-500', 'bg-violet-100', 'text-violet-700', 'text-violet-700',
  'bg-cyan-500', 'bg-cyan-100', 'text-cyan-700', 'text-cyan-700',
];